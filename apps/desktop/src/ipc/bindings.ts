...
export const STT_PROVIDERS = [{"id":"groq","keyId":"groq","label":"Groq · Whisper","supportsTranslate":true},{"id":"openai","keyId":"openai","label":"OpenAI · gpt-4o mini","supportsTranslate":true},{"id":"xai","keyId":"xai","label":"Grok · Speech-to-Text","supportsTranslate":false}] as const;
